...
<section class="py-4">
  <div class="container">
    ...
    @else
      <div class="alert alert-light border rounded-4" style="color:#6C757D;">
        ยังไม่มีประกาศ
      </div>
    @endif
  </div>
...
<!-- พื้นที่ “ต่อยอดในอนาคต” (การ์ดว่าง) -->
<section class="pb-5">
  <div class="container">
    <div class="row g-3">
      <div class="col-12 col-md-6">
        <div class="p-4 bg-white border rounded-4 shadow-sm h-100">
          ...
          <p class="mb-0" style="color:#6C757D;">
            ตรวจสอบประกาศก่อนจองสนาม เพื่อดูช่วงเวลาปิดปรับปรุงหรือโปรโมชั่นล่าสุด
          </p>
        </div>
      </div>
      <div class="col-12 col-md-6">
        <div class="p-4 bg-white border rounded-4 shadow-sm h-100">
          ...
          <p class="mb-0" style="color:#6C757D;">
            หากมีการเปลี่ยนแปลงสถานะการจอง คุณจะเห็นแจ้งเตือนที่มุมขวาบนของหน้าเว็บ
          </p>
        </div>
      </div>
    </div>
